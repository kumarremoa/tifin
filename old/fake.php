                           ...
                           <div class="container">
                              ...
                              <div class="row">
                                <div class="col-md-8 about">
                                	   <form method="get" class="azqf-query-form filter_form" data-name="filter_form" action="#">
                                       ...
                                       <div class="wrapper">
                                          ...
                                          <div class="section">
                                             ...
                                             <div></div>
                                             <label for="uniqid0">Contact Information :</label>
                                             <div class="row">
                                               <div class="col-md-4">
                                                  <div class="azen-food-form-white-field">
                                                   <input name="cus_name" type="text" value="" placeholder="Your name">
                                                </div>
                                               </div>
                                               <div class="col-md-4">
                                                   <div class="azen-food-form-white-field">
                                                      <input name="cus_email" type="text" value="" placeholder=" Email">
                                                   </div>
                                               </div>
                                               <div class="col-md-4"> 
                                                <div class="azen-food-form-white-field">
                                                   <input name="cus_mobile" type="text" value="" placeholder="Phone">
                                                </div>
                                             </div>
                                                  ...
                                                  <div class="handle-counter" id="handleCounter">                            
                                                      <fieldset >
                                                        <div class="form-group">
                                                          ...
                                                          <?php if($value['title']=='Special Thali'){?>
                                                          <input id="colorful" class="form-control" type="number" value="0" min="1" max="90" value="1" />
                                                          <?php }else{?>
                                                   ...
                                                   <div class="handle-counter" id="handleCounter">
                                                      <fieldset>
                                                        <div class="form-group">
                                                          ...
                                                          <?php if($value['title']=='Basic Thali'){?>
                                                          <input id="colorful1" class="form-control" type="number" value="1" min="1" max="90" />
                                                          <?php }else{?>
                                                  ...
                                                  <div class="handle-counter" id="handleCounter">
                                                      <fieldset >
                                                        <div class="form-group">
                                                          ...
                                                          <?php if($value['title']=='Medium Thali'){?>
                                                          <input id="colorful2" class="form-control" type="number" value="1" min="1" max="90" />
                                                          <?php }else{?>
                                          ...
                                          <div class="section">
                                             ...
                                             <div></div>
                                             <label for="uniqid3">Rating</label>
                                             <div class="">
                                                <div class="row">
                                                  <div class="col-md-12">
                                          ...
                                          <div class="">
                                             <input type="hidden" name="post_type" value="product"><input type="hidden" name="role" value="vendor">
